...
namespace Ch11Ex04
{
    class Checker
    {
        ...
        {
            //Check if param1 is of this class type, or inherits from this type, or can be boxed into this type.
            if (param1 is ClassA)
                WriteLine("Variable can be converted to ClassA.");
            else
                WriteLine("Variable can't be converted to ClassA.");

            //Check if param1 is of this interface type, or implements this interface.
            ...
            //Check if param1 is of this value type, or can be unboxed into this type.
