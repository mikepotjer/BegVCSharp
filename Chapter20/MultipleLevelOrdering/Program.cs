...
namespace MultipleLevelOrdering
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // Sort by 3 fields, and create a new object for the results (rather than a Customer class).
            var queryResults =
                from c in customers
                orderby c.Region, c.Country, c.City
                select new { c.ID, c.Region, c.Country, c.City };

            // Any individual field can be sorted in descending order.
            //var queryResults =
            //    from c in customers
