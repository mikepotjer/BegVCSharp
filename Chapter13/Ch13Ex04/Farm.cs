...
namespace Ch13Ex04
{
        ...
        where T : Animal
    {
        ...
        // In order for a collection initializer to work, the class must define an Add()
        // method. The compiler doesn't know that we want to add items to the Animals
        // collection, so the Add() will take care of that. Otherwise, a nested initializer
        // for the Animals collection will eliminate the need for this (see Program.cs).
